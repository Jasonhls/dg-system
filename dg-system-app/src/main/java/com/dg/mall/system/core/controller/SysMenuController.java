...
public class SysMenuController {
    ...
    public ResponseData userMenuTree(@RequestParam("phone") String phone) {
        List<SysMenuDTO> sysMenuDTOS = sysMenuService.userMenuTree(phone);
        return ResponseData.success(sysMenuDTOS);
