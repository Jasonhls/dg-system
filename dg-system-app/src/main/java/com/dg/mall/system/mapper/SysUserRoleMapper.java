...
public interface SysUserRoleMapper extends BaseMapper<SysUserRole> {
	...
	void deleteUserByRoleIds(@Param("roleIds") List<Integer> roleIds);
	 ...
	 * @return
	 */
	int updateIsGeneralAdministrator(@Param("userVO") SysUserRoleVO userVO);
	 ...
	 * @return
	 */
	Integer queryUserAdministratorsByRoleId(@Param("userVO") SysUserRoleVO userVO);
	
	/**
	 * 该角色下其他成员关联角色更新为最新二级菜单角色
	 * @param userVO
	 * @return
	 */
	int updateUserRoleById(@Param("userVO") SysUserRoleVO userVO);
}
